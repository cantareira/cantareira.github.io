...
* **Média histórica dos últimos 30 dias**: `r as.numeric(round(pluv.hist$ph.m[time(pluv.hist)==max(time(c2.w))-29]*30,0))`	
<br>	
...
[^2]: Sujeito a atrasos e lacunas nos fins de semanas e feriados da divulgação de dados da SABESP.
