...
* Fonte: [Boletins diários da SABESP de vazão do sistema](http://www2.sabesp.com.br/mananciais/divulgacaopcj.aspx), recuperação semi-automatizada.
* [Arquivo de dados](/data/data_ocr_cor2.csv)
* [Metadados](data_ocr_cor2_metadata.html)
* Podem conter erros de leitura devido ao processo semi-automático de recuperação dos dados.
