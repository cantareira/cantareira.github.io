...
a curva resultante do ajuste do modelo para o período de maio/2014 e maio/2105.
...
mês. Projeções para períodos maiores por muitas vezes resultam
...
para a bacia PCJ (disponível no
\href{http://www.sspcj.org.br/index.php/boletins-diarios-e-relatorios-telemetria-pcj/boletimdiario}{site do Comitê PCJ}), 
que por
sua vez utiliza previsões do INPE (Instituto Nacional de Pesquisas
Espaciais).  Para a projeções de um mês usamos três cenários baseados
